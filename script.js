...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createGameCard(game) {
        ...
        const coverPath = game.Portada && game.Portada.trim() !== "" 
            ? game.Portada 
        ...
        card.innerHTML = `
            ...
            <div class="game-info">
                ...
                <p class="game-size">📦 ${game.Tamaño || 'Tamaño no disponible'}  💲${precio} CUP</p>
                <div class="btn-group">
    ...
    function filterGames() {
        ...
        filteredGames = gamesData.filter(game => {
            const matchesSearch = searchTerm === '' || (game.Nombre || '').toLowerCase().includes(searchTerm);
